...
class ReceiveMessageView(View):
    ...
    def dispatch(self, request, *args, **kwargs):
        mapping_obj = OrgWhatsappMapping.objects.get(url=kwargs['url']) 
        self.messenger = WhatsApp(mapping_obj.permanent_token,  mapping_obj.whatsapp_number_id)
        logging.basicConfig(
        ...
        if changed_field == "messages":
            ...
            if new_message:
                ...
                if message_type == "text":
                    ...
                    image_filename = self.messenger.download_media(image_url, mime_type)
                    ...
                    video_filename = self.messenger.download_media(video_url, mime_type)
                    ...
                    file_filename = self.messenger.download_media(file_url, mime_type)
